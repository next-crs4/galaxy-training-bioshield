...
Since the annotation process can take several hours, 
we will instead use precomputed annotation results by dragging and dropping them from the <strong>Datasets</strong> history.
</div>
